...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="relative flex flex-col items-center justify-center pt-32 pb-4 px-6">
      
      {/* Decorative Squares - Absolute Left/Right Center */}
      <div className="absolute left-6 top-1/2 -translate-y-1/2 w-4 h-4 bg-syncra-lime hidden md:block" />
      <div className="absolute right-6 top-1/2 -translate-y-1/2 w-4 h-4 bg-syncra-lime hidden md:block" />

      {/* Content */}
      <div className="max-w-3xl mx-auto text-center z-10 flex flex-col items-center gap-10">
        
        {/* H1 Text - Static, appears immediately */}
        <h1 className="text-xl md:text-3xl lg:text-4xl leading-relaxed font-mono uppercase tracking-wide text-syncra-lime md:whitespace-nowrap">
          Our mission is to make every<br className="md:hidden" /> event unforgettable.
        </h1>
