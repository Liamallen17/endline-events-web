...
export const Contact: React.FC = () => {
  return (
    <section id="contact" className="py-24 px-6 md:px-12 border-t border-syncra-lime/20">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
        ...
        <div>
          <div className="sticky top-24">
            ...
            <h3 className="text-2xl md:text-4xl font-mono uppercase leading-snug mb-8">
            ...
            <div className="w-80 aspect-[3/4] bg-gray-900 mt-12">
